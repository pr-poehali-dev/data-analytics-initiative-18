        ...
        <div className="flex-1 flex flex-col lg:flex-row">
            ...
            <div className="flex-1 p-2">
              <div className="mb-4">
                ...
                <div className="mt-1 space-y-0.5">
                  {["общий", "знакомства", "мемы", "поиск-тиммейтов"].map((channel) => (
                    <div
                      key={channel}
          ...
          <div className="flex-1 flex flex-col">
            ...
            <div className="flex-1 p-2 sm:p-4 space-y-4 sm:space-y-6 overflow-y-auto">
              ...
              {/* Сообщение пользователя с карточкой */}
              <div className="flex gap-2 sm:gap-4">
                  ...
                  {[
                    {
                      ...
                      title: "Сообщество геймеров",
                      desc: "Тысячи игроков со всего СНГ",
                    },
                    {
                      icon: <MessageCircle className="w-4 h-4 sm:w-5 sm:h-5" />,
                      title: "Удобное общение",
                      desc: "Чаты, голос и посты в одном месте",
                    },
                    {
                      icon: <Heart className="w-4 h-4 sm:w-5 sm:h-5" />,
                      title: "Поиск по интересам",
                      desc: "Находи людей с похожими вкусами",
                    },
                    {
                      icon: <Shield className="w-4 h-4 sm:w-5 sm:h-5" />,
                      title: "Без токсичности",
                      desc: "Модерация и репутационная система",
                    },
                  ].map((feature, index) => (
                    <div
                      key={index}
