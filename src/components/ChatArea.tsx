...
const ChatArea = ({ onSidebarOpen, onRegisterClick }: ChatAreaProps) => {
  return (
    <div className="flex-1 flex flex-col lg:flex-row">
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="h-12 bg-[#36393f] border-b border-[#202225] flex items-center px-4 gap-2">
          ...
          <span className="text-[#8e9297] text-sm hidden sm:block">Общайся, играй, дружи</span>
        ...
        <div className="flex-1 p-2 sm:p-4 space-y-4 sm:space-y-6 overflow-y-auto">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="text-[#dcddde] text-sm sm:text-base">
                <p className="mb-3 sm:mb-4">
                  <strong>Добро пожаловать в Frikords!</strong> Место, где геймеры находят друзей, общаются и вместе исследуют игровые миры.
                </p>
                <div className="bg-[#2f3136] border-l-4 border-[#5865f2] p-3 sm:p-4 rounded">
                  <h3 className="text-white font-semibold mb-2 text-sm sm:text-base">Что тебя ждёт на Frikords:</h3>
                  <ul className="space-y-1 text-xs sm:text-sm text-[#b9bbbe]">
                    <li>🎮 Профиль геймера с любимыми играми и жанрами</li>
                    <li>🤝 Знакомства и поиск тиммейтов по интересам</li>
                    <li>💬 Чаты, каналы и голосовые комнаты</li>
                    <li>📰 Лента постов и геймерских новостей</li>
                    <li>🏆 Турниры и совместные ивенты</li>
                  </ul>
                </div>
              </div>
            </div>
          ...
          <div className="flex gap-2 sm:gap-4">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="text-[#dcddde] mb-3 text-sm sm:text-base">
                Ищу новых друзей для совместных игр! Обожаю RPG и шутеры 🎮
              </div>
              ...
              <div className="bg-[#2f3136] border border-[#202225] rounded-lg overflow-hidden w-full max-w-sm">
                ...
                <div className="pt-4 sm:pt-6 px-3 sm:px-4 pb-3 sm:pb-4">
                  <div className="mb-3 sm:mb-4">
                    ...
                    <div className="text-[#b9bbbe] text-xs sm:text-sm mb-2">shadow#7777 · Москва</div>
                    <div className="flex flex-wrap gap-1">
                      {["RPG", "Шутеры", "Open World"].map((tag) => (
                  ...
                  <div className="mb-3 sm:mb-4">
                    <div className="bg-[#36393f] rounded-lg p-2 sm:p-3">
                      <div className="flex items-center gap-2 text-[#dcddde] text-xs sm:text-sm">
                        <span>🎮</span>
                        <span>Играю каждый вечер, ищу компанию!</span>
                      </div>
                    </div>
                  </div>
          ...
          <div className="flex gap-2 sm:gap-4">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="text-[#dcddde] text-sm sm:text-base">
                Наконец-то соцсеть для нас! Тут хоть поймут что такое "последний патч сломал всё" 😂
              </div>
            </div>
          </div>
          ...
          <div className="bg-[#2f3136] border border-[#202225] rounded-lg p-4 sm:p-6 mt-6 sm:mt-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 mb-4 sm:mb-6">
              <div className="text-center">
                ...
                <p className="text-[#b9bbbe] text-xs sm:text-sm">Расскажи о себе и любимых играх</p>
              </div>
              <div className="text-center">
                <div className="w-10 h-10 sm:w-12 sm:h-12 bg-[#5865f2] rounded-full flex items-center justify-center mx-auto mb-3">
                ...
                <p className="text-[#b9bbbe] text-xs sm:text-sm">Знакомься по интересам и жанрам</p>
              </div>
              <div className="text-center">
                <div className="w-10 h-10 sm:w-12 sm:h-12 bg-[#5865f2] rounded-full flex items-center justify-center mx-auto mb-3">
                  <span className="text-white font-bold text-sm sm:text-base">3</span>
                </div>
                <h3 className="text-white font-medium mb-2 text-sm sm:text-base">Играй вместе</h3>
                <p className="text-[#b9bbbe] text-xs sm:text-sm">Собирай команду и участвуй в ивентах</p>
              </div>
            </div>

            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <Button className="bg-[#5865f2] hover:bg-[#4752c4] text-white px-6 sm:px-8 py-2 sm:py-3 rounded text-sm font-medium" onClick={onRegisterClick}>
          ...
          <div className="bg-[#2f3136] border border-[#202225] rounded-lg p-4 sm:p-6">
            <h3 className="text-lg sm:text-xl font-bold text-white mb-4">Почему Frikords?</h3>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
              {[
                { icon: <Users className="w-4 h-4 sm:w-5 sm:h-5" />, title: "Сообщество геймеров", desc: "Тысячи игроков со всего СНГ" },
                { icon: <MessageCircle className="w-4 h-4 sm:w-5 sm:h-5" />, title: "Удобное общение", desc: "Чаты, голос и посты в одном месте" },
                { icon: <Heart className="w-4 h-4 sm:w-5 sm:h-5" />, title: "Поиск по интересам", desc: "Находи людей с похожими вкусами" },
                { icon: <Shield className="w-4 h-4 sm:w-5 sm:h-5" />, title: "Без токсичности", desc: "Модерация и репутационная система" },
              ].map((feature, index) => (
                <div key={index} className="flex items-start gap-2 sm:gap-3 p-2 sm:p-3 rounded hover:bg-[#36393f] transition-colors">
      ...
      <div className="hidden xl:block w-60 bg-[#2f3136] p-4">
        <div className="mb-4">
          ...
          <div className="space-y-2">
            {[
              { name: "ShadowKnight", status: "RPG · Шутеры", avatar: "S", color: "from-purple-500 to-pink-500", badge: "🏆" },
              { name: "NightWolf", status: "Open World", avatar: "N", color: "from-green-500 to-blue-500", badge: "⚔️" },
              { name: "ProGamer", status: "Ищет тиммейтов", avatar: "П", color: "from-blue-500 to-purple-500", badge: "🔥" },
              { name: "IceQueen", status: "Инди · Хорроры", avatar: "I", color: "from-cyan-500 to-blue-500", badge: "⭐" },
            ].map((user, index) => (
